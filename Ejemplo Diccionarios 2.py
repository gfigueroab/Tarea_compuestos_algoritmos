#Crear un diccionario que permita alamcenar 5 artículos,
#utilizar como clave el nombre de prodcutos y como valor del precio mismo.
#Desarrollar además las funciones de:
#1) Imprimir en forma completa el diccionario
#2) Imprimir solo los artículos con precio suoerior a 100
